...
const http = require('http');//criar instancias 
const express = require('express');
//constrói um objeto express
const app = express();
//importa o body-parser
const bodyParser = require('body-parser');//le o json em texto e tranforma em um formato interno javascript, jsoon so transporta os dados do cliente pro servidor
